...
<main class="page_content">
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service_item">
                        <div class="item_icon"><svg width="50" height="53" viewBox="0 0 50 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service_item">
                        <div class="item_icon"><svg width="25" height="52" viewBox="0 0 25 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service_item">
                        <div class="item_icon"><svg width="50" height="50" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service_item">
                        <div class="item_icon"><svg width="36" height="53" viewBox="0 0 36 53" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service_item">
                        <div class="item_icon"><svg width="48" height="40" viewBox="0 0 48 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="service_item">
                        <div class="item_icon"><svg width="58" height="21" viewBox="0 0 58 21" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <section class="service_section bg_gray_dark">
        <div class="service_split_wrapper">
            ...
            <div class="service_split_item">
                <div class="item_image"><img src="<?= base_url("public/user/assets/images/services/service_img_2.jpg"); ?>" alt="ProMotors - Service Image"></div>
                <div class="item_content">
                    <div class="section_heading">
                        <div class="outline_text">Service</div>
    ...
    <section class="brand_logo_section section_space_lg pb-0 text-center">
        ...
        <div class="brand_logo_carousel brand_logo_blur_effect row align-items-center" data-slick='{"dots":false, "arrows": false}'>
            <div class="col-"><a class="brand_logo_item"><img src="<?= base_url("public/user/assets/images/brands/brand_logo_img_1.png"); ?>" alt="ProMotors - TOYOTA Logo"></a></div>
            <div class="col-"><a class="brand_logo_item"><img src="<?= base_url("public/user/assets/images/brands/brand_logo_img_2.png"); ?>" alt="ProMotors - Ford Logo"></a></div>
            <div class="col-"><a class="brand_logo_item"><img src="<?= base_url("public/user/assets/images/brands/brand_logo_img_3.png"); ?>" alt="ProMotors - DODGE Logo"></a></div>
            <div class="col-"><a class="brand_logo_item"><img src="<?= base_url("public/user/assets/images/brands/brand_logo_img_4.png"); ?>" alt="ProMotors - JAGUAR Logo"></a></div>
            <div class="col-"><a class="brand_logo_item"><img src="<?= base_url("public/user/assets/images/brands/brand_logo_img_5.png"); ?>" alt="ProMotors - HONDA Logo"></a></div>
            <div class="col-"><a class="brand_logo_item"><img src="<?= base_url("public/user/assets/images/brands/brand_logo_img_6.png"); ?>" alt="ProMotors - BMW Logo"></a></div>
        </div>
    </section>
</main>
