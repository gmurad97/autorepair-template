...
<main class="page_content">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="hero_section_image">
                        <img data-parallax='{"scale" : 0.6, "smoothness": 8}' src="<?= base_url('public/user/assets/images/hero/hero_image_1.png'); ?>" alt="ProMotors – Car Service Image">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="counter_section bg_gray_dark section_space_md">
        <div class="container">
            <div class="counter_items_group row">
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="counter_item">
                        <div class="counter_value">
                            <span class="odometer" data-count="7000">0</span>
                            <span>+</span>
                        </div>
                        <hr>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="counter_item">
                        <div class="counter_value"><span class="odometer" data-count="33">0</span>
                            <span>+</span>
                        </div>
                        <hr>
                        <p class="counter_description mb-0">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="counter_item">
                        <div class="counter_value"><span class="odometer" data-count="500">0</span>
                            <span>+</span>
                        </div>
                        <hr>
                        <p class="counter_description mb-0">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="counter_item">
                        <div class="counter_value"><span class="odometer" data-count="99">0</span>
                            <span>%</span>
                        </div>
                        <hr>
                        <p class="counter_description mb-0">
            ...
            <div class="section_heading">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 d-none d-lg-flex justify-content-end">
                        <a class="btn btn-primary" href="<?= base_url('services'); ?>">
    ...
    <section class="video_section">
        <div class="container">
            ...
            <div class="video_wrap parallaxie text-center" style="background-image: url('<?= base_url("public/user/assets/images/video/video_poster_1.jpg"); ?>');">
                <a class="video_play_btn popup_video" href="https://www.youtube.com/watch?v=2D4qrO7fwcU">
    ...
    <section class="service_section bg_gray_dark">
        <div class="service_split_wrapper">
            ...
            <div class="service_split_item">
                <div class="item_image">
                    <img src="<?= base_url('public/user/assets/images/services/service_img_2.jpg'); ?>" alt="ProMotors - Service Image">
                </div>
                <div class="item_content">
                    <div class="section_heading">
                        <div class="outline_text">Service</div>
